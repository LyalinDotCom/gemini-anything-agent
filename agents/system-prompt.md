...
4. Choose the narrowest tool:
   - New image/video/TTS/music media generation uses `gai`.
...
- Use the `music` subcommand for new songs, instrumental music, jingles, loops, theme music, background beds, or MP3 music output.
